...
int META_LEARNING=0, RELATIVE=0, N_RULES=0, N_POINTS=0, N_ITEMSETS=0, COUNT_TARGET[MAX_CLASSES], TARGET_ID[MAX_CLASSES], MIN_SIZE=1, MAX_SIZE=MAX_RULE_SIZE, MIN_RULES=1, MAX_JUDGEMENTS=1, CHECK_REPEATED=0, OCCURS_CMP=0, TRAIN_EMPTY=0;
long N_TRANSACTIONS=0, N_TESTS=0;
int MIN_COUNT=1;
float MIN_CONF=0.001, MIN_LEVEL=0.5, MIN_SUPP=0.01, FACTOR=1.00;
char *DELIM=" ";
